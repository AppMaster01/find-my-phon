// ignore_for_file: sized_box_for_whitespace, invalid_use_of_pr  ected_member, use_build_context_synchronously
...
class ButtonController extends GetxController {
  ...
  showbuttonad(BuildContext context, String page, String name, var arg) async {
    if (FindPhon.value["COUNTER"] == buttoncounter.value) {
      showDialog(
      ...
      if (FindPhon.value[name]["INTER_AD_TYPE"] == 'ADMOB') {
        InterstitialAd.load(
          adUnitId: FindPhon.value[name]["INTER_ADMOB"],
          ...
          adLoadCallback: InterstitialAdLoadCallback(onAdLoaded: (ad) {
            ...
            InterstitialAd.load(
              adUnitId: FindPhon.value["interstitial"],
              // adUnitId: "/6499/example/interstitial",
              request: const AdManagerAdRequest(),
              adLoadCallback: InterstitialAdLoadCallback(onAdLoaded: (ad) {
                ad.show();
      ...
      if (FindPhon.value[name]["INTER_AD_TYPE"] == 'FB') {
        FacebookInterstitialAd.loadInterstitialAd(
          placementId: FindPhon.value["INTER_FB"],
      ...
      if (FindPhon.value[name]["INTER_AD_TYPE"] == "URL") {
