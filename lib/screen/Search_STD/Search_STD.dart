// ignore_for_file: deprecated_member_use, camel_case_types, prefer_final_fields, invalid_use_of_protected_member, avoid_function_literals_in_foreach_calls, sized_box_for_whitespace
...
class Search_STD extends StatefulWidget {
  const Search_STD({Key? key}) : super(key: key);

  @override
  State<Search_STD> createState() => _Search_STDState();
}

class _Search_STDState extends State<Search_STD> {
  ...
  getLocalJson() {
    return rootBundle.loadString('asset/india.json'); // Read your local Data
  }

  Future getLocalJsonData() async {
    final response = json.decode(await getLocalJson());
    var tempList = [].obs;
    for (var i in response['citylist']) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: controllerAppbar.getappbar('Search STD Code', () {
      ...
      body: Stack(
        children: [
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      width: ScreenSize
                                                          ...
                                                          17,
                                                      child: Text(
                                                        '${fullData.value[indexs]["code"]}',
                                                        style:
                                                            GoogleFonts.anekTamil(
                                                                color:
                                                                    Colors.black,
                                                                fontSize: ScreenSize
                                                                    .fSize_16(),
                                                    ...
                                                    Container(
                                                      ...
                                                      width: ScreenSize
                                                          ...
                                                          50,
                                                      child: Text(
                                                        '${fullData.value[indexs]['cityName']}',
                                                        style:
                                                            GoogleFonts.anekTamil(
                                                                color:
                                                                    Colors.black,
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  width: ScreenSize
                                                      ...
                                                      50,
                                                  child: Text(
                                                    '${searchData.value[indexs]['cityName']}',
                                                    style: GoogleFonts.anekTamil(
                                                        color: Colors.black,
                                                        fontSize:
                                                            ScreenSize.fSize_16(),
          ...
          controllertextfiled.gettextfiled(
              'Search STD Code', textEditingController.value, onSearchTextChanged),
